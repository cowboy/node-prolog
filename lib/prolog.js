...
ProLog.prototype.format = function(data) {
  ...
  return this.eachLine(data.message, function(line, index) {
    // Passing a new, augmented, data object with additional properties into
    // the format template makes logging output so much more EXCITING
    var dataPlus = Object.create(data, {
      index: {value: index},
      message: {value: line},
      date: {get: function() {
        return this.formatDate && this.formatDate(data, index);
      }.bind(this)},
      debug: {get: function() {
        return this.formatDebug && this.formatDebug(data, index);
      }.bind(this)},
      padding: {get: function() {
        return this.formatPadding && this.formatPadding(data, index);
      }.bind(this)},
    });
...
ProLog.prototype.formatDate = function(data, index) {
